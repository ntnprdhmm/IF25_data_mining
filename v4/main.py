...
for K in K_VALUES:
    ...
    for classification in clf.classifications:
        ...
        f = open(CLUSTER_RESULTS_PATH + "/" + CRUDE_RESULTS_BASENAME + str(classification) + ".csv", 'a')
        ...
        start_time = time.time()
        f = open(CLUSTER_RESULTS_PATH + "/" + RESULTS_BASENAME + str(classification) + ".csv", 'a')
        ...
        start_time = time.time()
        f = open(CLUSTER_RESULTS_PATH + "/" + STATS_RESULTS_BASENAME + str(classification) + ".txt", 'a')
